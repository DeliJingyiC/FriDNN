...
mkdir output/$SLURM_JOB_ID/model
...
python train_test/main.py --timit_directory=timit --model_dir=output/$SLURM_JOB_ID/model --output_dir=output --job_id=$SLURM_JOB_ID --window_size=3200 --delay=1600 > "output/${SLURM_JOB_ID}/stdout.log"
