...
python train_test/predict.py --audio_dir=/users/PAS2062/delijingyic/project/org_wavegan/output/17440244/Audio --model_dir=model_in_paper --test_only --output_dir=output --job_id=$SLURM_JOB_ID #> "sbatch/${SLURM_JOB_ID}_main.log"