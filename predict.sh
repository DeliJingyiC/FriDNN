...
#python train_test/predict.py --audio_dir=/users/PAS2062/delijingyic/project/org_wavegan/output/17524888/Audio --model_dir=output/17471739/model --test_only --output_dir=output --job_id=$SLURM_JOB_ID --window_size=3200 #> "output/${SLURM_JOB_ID}/stdout.log"
python train_test/predict.py --audio_dir=/users/PAS2062/delijingyic/project/org_wavegan/output/17533141/Audio --model_dir=output/17471739/model --test_only --output_dir=output --job_id=$SLURM_JOB_ID --window_size=3200 #> "output/${SLURM_JOB_ID}/stdout.log"
