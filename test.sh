...
python train_test/main.py --timit_directory=timit --model_dir=model_in_paper --test_only --output_dir=output --job_id=$SLURM_JOB_ID #> "sbatch/${SLURM_JOB_ID}_main.log"